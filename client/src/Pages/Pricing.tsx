...
const Pricing = () => {
  ...
  return (
    <main className="dark:bg-black bg-gray-200 text-center text-white font-poppins flex flex-col items-center justify-center gap-20 pb-44 pt-10 px-8">
      ...
      <div id="0" className="flex justify-center items-stretch gap-4 lg:flex-nowrap flex-wrap w-full px-10">
        ...
        <div id="1" className="relative flex flex-col gap-y-6 dark:bg-gradient-to-t dark:from-gray-800 dark:to-gray-900 bg-gray-300 h-[17rem] items-center justify-around p-8 rounded-2xl md:w-[20rem] w-full">
        ...
        <div id="2" className="relative flex flex-col gap-y-6 dark:bg-gradient-to-t dark:from-gray-800 dark:to-gray-900 bg-gray-300 h-[17rem] items-center justify-around p-8 rounded-2xl md:w-[20rem] w-full">
          <h3 className="bg-gradient-to-r from-purple-700 to-blue-700 text-transparent bg-clip-text text-5xl font-black text-blue-700">
            Premium
          </h3>
          <p className="text-xl dark:text-gray-300 text-gray-800 font-light">
