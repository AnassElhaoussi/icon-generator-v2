        ...
        <h1 className=" md:text-[6.5rem] relative z-1 text-6xl font-extrabold dark:text-gray-200 text-gray-800">
          ...
          <span className="relative z-5 text-transparent bg-clip-text dark:bg-gradient-to-r dark:from-blue-700 dark:to-purple-700 bg-gradient-to-r from-blue-800 to-blue-600">
            ...
            <Image
              src={circle}
              alt="homepage_circle"
              className="absolute md:w-72 w-44 -z-1 top-2 w right-28 dark:w-0"
            />
          </span>
        </h1>
        <p className="dark:text-gray-400 text-gray-600 w-2/3 md:text-normal text-sm">
          Use artificial intelligence to generate icons, with the help of our
          guide we suggest the best prompts for the best outcome.
        </p>
        <button
          onClick={() => {
