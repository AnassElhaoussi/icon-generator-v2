  ...
  return (
    <section id="home" className="flex w-full items-center justify-center p-10">
        <div className="relative flex flex-col gap-6 items-center lg:w-3/4 w-full text-center ">
            ...
            <h1 className="md:text-[6.8rem] relative z-1 text-7xl font-extrabold dark:text-gray-200 text-gray-800">
            ...
            }} className="py-2 px-10 bg-blue-700 rounded-xl dark:text-white hover:text-black shadow-[0_20px_35px_-15px_rgba(0,0,0,0.3)] shadow-blue-600 text-white border-4 border-transparent hover:bg-transparent hover:border-blue-600 text-xl font-light transition-all">
