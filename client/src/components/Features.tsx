    ...
    return (
        <section id="features" className="flex flex-col gap-28 md:px-20 px-10">
            <div className="relative space-x-2">
                ...
                <h2 className="relative z-10 lg:text-8xl md:text-7xl text-6xl dark:text-gray-200 text-gray-800 font-bold">Features</h2>
            ...
            <div className="flex items-center justify-center gap-5 flex-wrap">
                <div className="relative flex w-[25rem] flex-col items-center gap-y-4 bg-gray-300 dark:bg-gradient-to-t dark:from-black dark:to-gray-900 px-10 pb-10 pt-20 rounded-2xl text-center">
                    ...
                    <h5 className="dark:text-gray-300 text-gray-700 xl:text-5xl text-3xl font-bold">Icon Variety</h5>
                ...
                <div className="relative flex w-[25rem] flex-col items-center gap-y-4 bg-gray-300 dark:bg-gradient-to-t dark:from-black dark:to-gray-900 px-10 pb-10 pt-20 rounded-2xl text-center">
                    ...
                    <h5 className="dark:text-gray-300 text-gray-700 xl:text-5xl text-3xl font-bold">Color Customization</h5>
                ...
                <div className="relative flex w-[25rem] flex-col items-center gap-y-4 bg-gray-300 dark:bg-gradient-to-t dark:from-black dark:to-gray-900 px-10 pb-10 pt-20 rounded-2xl text-center">
                    ...
                    <h5 className="dark:text-gray-300 text-gray-700 xl:text-5xl text-3xl font-bold">AI Powered</h5>
