      ...
      <div className="flex flex-col items-center gap-y-16 lg:w-[80%]">
        <div className="space-y-4">
          <div className="relative">
            <h1 className="relative z-10 md:text-8xl sm:text-7xl text-6xl md:font-black font-extrabold">
              Buy credits!
            </h1>
        ...
        <div className="flex justify-center items-stretch gap-4 lg:flex-nowrap flex-wrap w-full px-10">
          <div className="flex flex-col gap-y-6 bg-gray-900 h-full items-center justify-around p-8 rounded-2xl shadow-lg  md:w-[20rem] w-full ">
            ...
            <button className="py-3 px-8 bg-blue-700 rounded-md font-light whitespace-nowrap">Go to dashboard</button>
          </div>
          <div className="flex flex-col gap-y-6 bg-gray-900 items-center justify-around p-8 rounded-2xl shadow-lg  md:w-[20rem] w-full">
            ...
            <button className="py-3 px-5 bg-gradient-to-r from-blue-700 to-purple-700 rounded-md font-light">Buy in 10$</button>
          </div>
          <div className="flex flex-col gap-y-6 bg-gray-900 items-center justify-around p-8 rounded-2xl shadow-lg  md:w-[20rem] w-full">
            <div className="space-y-2">
            ...
            <button className="py-3 px-5 bg-gradient-to-r from-blue-700 to-purple-700 rounded-md font-light">Buy in 20$</button>
          </div>
        </div>
      </div>
    </main>
